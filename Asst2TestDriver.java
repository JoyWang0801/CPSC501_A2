...
//				driver.runTest( "Test String" );
			...
			System.out.println("usage: java Asst2TestDriver <object inspector name> [false]\n\nFirst argument is the name of the " +
					"object inspector class to load, this class should be in the current directory. the second argument is " +
					"optional, if set to false the recursive introspection will not be run for the tests.\n\n");
    }
}
